    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center gap-4">
        ...
        <footer className="flex flex-wrap gap-2 mt-4">
          {repo && <a target="_Blank" href={repo} className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium transition bg-gray-900 text-white rounded-full hover:bg-gray-800">
          ...
          {demo && <a target="_Blank" href={demo} className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium transition bg-gray-900 text-white rounded-full hover:bg-gray-800">
